				...
				<div class="row" style="border-bottom: 1px solid black;">
					 ...
					 <div style="width: 80%;float: left;padding-left: 10px;">
						 <font class="text-left">
							 <h2><b><?php echo $row_event_post['post_head1'] ?></b></h2>
							 <p><?php echo $row_event_post['post_detail1'] ?></p>
						 </font>
					 </div>
				 </div>	
...
<?php do { ?>			  
				<div class="row" style="border-bottom: 1px solid black;">
					 ...
					 <div style="width: 80%;float: left;padding-left: 10px;">
						 <font class="text-left">
							 <h2><b><?php echo $row_update_post['post_head'] ?></b></h2>
							 <p><?php echo $row_update_post['post_detail'] ?></p>
						 </font>
					 </div>
				 </div>	
...
<?php 
		...
		echo "swal({title: \"กำลังพาไปหน้าเว็บของ ผู้ดูแลระบบ\",
				text: \"ระบบกำลังพาท่านไป...\",
				icon: \"success\",
				buttons: false,
			  })\n";
		echo "setTimeout(function(){ window.location.href=\"edithome.php\"; }, 4500);";
		echo "</script>";
	}
		 ?>
<!-- InstanceEndEditable -->	
