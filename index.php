...
<body style="background-image: url(assets/img/websettingimg/<?php echo $row_config['background_img'] ?>);font-family: 'Kanit', sans-serif;height: 100%;;margin: 0;">
...
<div style="padding-top:4%;"></div>
    ...
    <div class="col-lg-4">
		...
		<div class="card" style="margin: auto;">
		  <div class="card-header text-white bg-dark text-center">ยินดีต้อนรับสู่ ' <?php echo $row_config['webname'] ?> '</div>
		  <div class="card-body">
				<form ACTION="<?php echo $loginFormAction; ?>" id="form1" name="form1" method="POST">
				  <div class="form-group">
					  <div class="input-group mb-2">
						...
						<input type="text" class="form-control" id="user" name="user" placeholder="ชื่อบัญชีผู้ใช้">
					  </div>
				  </div>
				  <div class="form-group">
					  <div class="input-group mb-2">
						...
						<input type="password" class="form-control" id="pass" name="pass" placeholder="รหัสผ่าน">
					  </div>
				  </div>
				  <a href="regis.php"><button type="button" class="btn btn-danger fa-pull-right"><i class="fas fa-edit"></i> ลงทะเบียน</button></a>
				  <button type="submit" class="btn btn-success fa-pull-right mr-2"><i class="fas fa-sign-in-alt"></i> เข้าสู่ระบบ</button>
				</form>
		  </div>
		</div>
	...
	<div style="padding-bottom:3%;"></div>
		...
		<div class="card bg-transparent" style="border: 0;">
		  <div class="card-body p-0 m-0 bg-transparent">
			<iframe style="width:100%;" src="custom-discord-widget/custom-discord-widget/dist/discordwidget.html" height="267px"allowtransparency="true" frameborder="0"></iframe>
		  </div>
		</div>
		</center>
