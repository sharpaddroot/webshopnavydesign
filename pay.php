    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          <a class="dropdown-item active" href="pay.php"><i class="fas fa-credit-card"></i> เติมเงิน</a>
...
<center>
			<div class="card" style="width: 95%;border: 2px solid black;">
			  <div class="card-header text-white text-left bg-danger" style="font-size: 20px;"><i class="fas fa-wallet"></i> เติมเงินผ่านระบบ True Wallet</div>
			  <div class="card-body" style="max-height: 350px;overflow: scroll;">
			  <img src="assets/img/Truemoney-wallet_thai.png"><div style="padding-top:1%;"></div>
				<div class="input-group mb-3 w-75" style="opacity: 0.7;">
				  <div class="input-group-prepend">
					<span class="input-group-text" id="basic-addon3">เติมเงินไปที่</span>
				  </div>
				  <input type="text" class="form-control text-center" id="SID" value="<?php echo $row_Recordset1['SID']; ?>" aria-describedby="basic-addon3" disabled>
				</div><form id="paywallet" name="paywallet" method="POST" enctype="multipart/form-paycard">
				<div class="input-group mb-3 w-75">
				  <div class="input-group-prepend">
					<span class="input-group-text" id="basic-addon3">กรอกเลขที่อ้างอิง</span>
				  </div>
				  <input pattern="[0-9]." type="text" class="form-control" id="number_payment" aria-describedby="basic-addon3" disabled>
				  <div class="input-group-append">
					<button class="btn btn-danger" type="submit" id="button-addon2" disabled>ตรวจสอบการเติมเงิน</button>
				  </div>
				</div></form>
				</div></div>
	        ...
	        <div style="padding-top:1%;"></div>
						<div class="card" style="width: 95%;border: 2px solid black;">
			  <div class="card-header text-white text-left bg-success" style="font-size: 20px;"><i class="fas fa-credit-card"></i> เติมเงินผ่านระบบบัตร True Money</div>
			  <div class="card-body" style="max-height: 350px;overflow: scroll;">
			  	<img src="assets/img/LOGO-PAY-WITH-TMN2.png" width="280px"><div style="padding-top:1%;"></div>
				<div class="input-group mb-3 w-75" style="opacity: 0.7;">
				  <div class="input-group-prepend">
					<span class="input-group-text" id="basic-addon3">เติมเงินไปที่</span>
				  </div>
				  <input type="text" class="form-control text-center" id="SID" value="<?php echo $row_Recordset1['SID']; ?>" aria-describedby="basic-addon3" disabled>
				</div><form id="paycard" name="paycard" method="POST" enctype="multipart/form-paycard">
				<div class="input-group mb-3 w-75">
				  <div class="input-group-prepend">
					<span class="input-group-text" id="basic-addon3">กรอกเลขบัตร 14 หลัก</span>
				  </div>
				  <input type="text" maxlength="14" class="form-control" id="number_payment" aria-describedby="basic-addon3" >
				  <div class="input-group-append">
					<button class="btn btn-success" type="submit" id="button-addon2">ตรวจสอบการเติมเงิน</button>
				  </div>
				</div></form>
				  </div></div>
