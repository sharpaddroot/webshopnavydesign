...
<body background="assets/img/blogbackground1.jpg">
...
<?php 
	...
	echo "setTimeout(function(){ window.location.href=\"home.php\"; }, 1500);";
	echo "</script>";
	}
?>
<span style="display: none;"><?php echo $row_Recordset1['u_name']; ?></span>
