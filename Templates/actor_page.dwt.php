    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="addstar.php"><i class="fas fa-gift"></i> เพิ่มแต้ม</a>
	  ...
	  <div class="col-lg-10 colsig1">
		  <div style="padding-top:1%;"></div>
		  	<div style="width: 95%;background-color: #333; color:azure;padding: 3px 3px;border-radius: 30px;margin:auto;">
				<marquee direction="left" style="width: 100%;z-index: -1;">ขณะเซิฟเวอร์ <u>' DEVWEB '</u> กำลังทำการปิดปรับปรุง "ขออภัยในความไม่สะดวก"</marquee>
			</div>
		  <div style="padding-top:1%;"></div>
